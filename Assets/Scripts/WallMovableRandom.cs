...
public class WallMovableRandom : MonoBehaviour
{
    [SerializeField] private bool isDown = true; //If the wall starts down, if not you must modify to false
    [SerializeField] private bool isRandom = true; //If you want that the wall go down random
